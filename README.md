...
- Design tools and process design kit (SiEPIC-EBeam-PDK, KLayout implementation)[installation instructions](https://github.com/siepic/SiEPIC_EBeam_PDK/wiki/Installation-instructions).
...
- Fork a copy of this GitHub repository into your own account:  [Create a new fork](../../fork).
- Turn on the GitHub Actions on your forked repository: [Actions](../../actions) (In your repository's page on GitHub, click on Actions in the top-menu bar, and Enable the workflows).
- [Optional] Install GitHub Desktop (or git) on your computer, and Clone a local copy: [Open with GitHub Desktop](x-github-client://openRepo/https://github.com/SiEPIC/openEBL-2026-05)
- Create your design, and ensure that the filename contains your [edX.org](https://www.edx.org/learn/engineering/university-of-british-columbia-silicon-photonics-design-fabrication-and-data-ana) (or GitHub username if the edX one is a random string that does not contain your name), and be formatted according to the course/workshop as follows:
  - EBeam_username.oas: for the [edX Phot1x silicon photonics design course](https://www.edx.org/learn/engineering/university-of-british-columbia-silicon-photonics-design-fabrication-and-data-ana)
  - ELEC413_username.oas: for the [UBC ELEC 413 course](https://ece.ubc.ca/courses/elec-413/)
  - SiEPIC_Passives_username.oas: for the [CMC SiEPIC Passives silicon photonics workshop](https://fabricinnovation.ca/workshop-passive-silicon-photonics-fabrication-2024)
...
- Ensure that your fork is up to date with the main SiEPIC repository.  Click "Sync fork" ![image](https://github.com/SiEPIC/openEBL-2024-05/assets/15843200/256c87dc-dd68-4606-8529-6c7f6ecf41fa)
- Upload your design(s) into the "submissions" folder, as a binary file, namely a .gds (GDSII format) or .oas (OASIS format) file. 
  - This can be done via the GitHub web page, by navigating to the [submissions folder](../../tree/main/submissions), then clicking on Add file, and Upload files. 
...
- Look for errors -- "All checks have failed" ![image](https://github.com/SiEPIC/openEBL-2024-05/assets/15843200/d5689514-eca0-423f-9288-b20ec4fdd5e9)
  - Click on Details
...
- After fixing the errors, you should have a green check mark as follows: ![image](https://github.com/SiEPIC/openEBL-2024-05/assets/15843200/4c502cc4-16c1-4115-8ad7-7d5fdfe715d3)   
...
- Create a [Pull Request](https://help.github.com/articles/using-pull-requests/) -- this will notify the team of your contribution, which we can aggregate into the main design file
- Return to the main repository, and ensure that your design is correctly merged. Download the Latest Merge file, below.

![image](https://github.com/SiEPIC/openEBL-2024-02/assets/15843200/e4785a27-b971-4a64-8796-1e351f30c00e)
